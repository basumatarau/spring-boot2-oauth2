...
INSERT INTO auth_schema.oauth_client_details (client_id, client_secret, scope, authorized_grant_types, authorities, access_token_validity, web_server_redirect_uri)
  VALUES ('clientId', '{bcrypt}$2a$10$vCXMWCn7fDZWOcLnIEhmK.74dvK1Eh8ae2WrWlhr2ETPLoxQctN4.', 'read,write', 'authorization_code,refresh_token,client_credentials', 'ROLE_CLIENT', 600, 'http://localhost:8080/oauth2/callback/local-auth-provider');
